...
{
    const wchar_t* directoryPath = L"C:\\Users\\User\\Documents\\Study_6sem\\Œ—Ë—œ\\OS13\\HT\\";
    wchar_t* fileName;
    std::wstring filePath(L"C:\\Users\\User\\Documents\\Study_6sem\\Œ—Ë—œ\\OS13\\HT\\test.ht");
    if (argv[1]) {
