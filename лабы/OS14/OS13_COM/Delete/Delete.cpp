...
int main(int argc, char* argv[])
{
	wchar_t* fileName;
	HT::HTHANDLE* HT;
	const wchar_t* directoryPath = L"C:\\Users\\User\\Documents\\Study_6sem\\ОСиСП\\OS14\\HT\\";
	std::wstring filePath(L"C:\\Users\\User\\Documents\\Study_6sem\\ОСиСП\\OS14\\HT\\test.ht");
	if (argv[1]) {
