...
int main(int argc, char* argv[])
{
	wchar_t* fileName;
	HT::HTHANDLE* HT;
	const wchar_t* directoryPath = L"C:\\Users\\User\\Documents\\Study_6sem\\ÎÑèÑÏ\\OS14\\HT\\";
	std::wstring filePath(L"C:\\Users\\User\\Documents\\Study_6sem\\ÎÑèÑÏ\\OS14\\HT\\test.ht");
	...
	if (argv[1] && argv[2] && argv[3]) {
		std::cout << "params" << argv[1] << argv[2] << argv[3];
		fileName = HTAPI::GetWC(argv[1]);
		std::wstring s(directoryPath);
		s += std::wstring(fileName);
		filePath = s;
